              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {transactions?.map((transaction) => (
                  <tr key={transaction.id}>
                    <td className="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">{transaction.account_owner}</td>
                    ...
                    <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                      <a href="#" className="text-pink-600 hover:text-pink-900">
                        Edit<span className="sr-only">, {transaction.transaction_id}</span>
                      </a>
                    </td>
                  </tr>
                ))}
