  ...
  return (
    <div className="flex justify-center items-center my-20">
      <div className="text-center">
        ...
        <h3 className="mt-2 text-lg font-semibold text-gray-900">No Connections Yet</h3>
        <p className="mt-1 text-lg text-gray-500">Get started by adding a bank connection to import transactions on the Net Worth & Accounts page.</p>
        {/* <div className="mt-6">
          <Link href='/accounts'>
            <button
              type="button"
