        ...
        <div className="mx-auto mt-10 max-w-2xl rounded-3xl ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="text-base leading-7 text-gray-600">
              One simple monthly price that includes all of the features Trckfi has to offer, which is growing every week!
            </p>
            <div className="mt-10 flex items-center gap-x-4">
              <h4 className="flex-none text-sm font-semibold leading-6 text-pink-600">What’s included</h4>
