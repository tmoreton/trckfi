      ...
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="block lg:flex min-h-full items-center justify-center p-5">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg mb-[75px]">
                          ...
                          <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                              ...
                              <input 
                                ...
                                readOnly
                                value={account?.name}
                                className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent font-bold appearance-none focus:outline-none focus:ring-0 peer"
                                required 
                            ...
                            <label 
                              ...
                              <input 
                                ...
                                className="hidden py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent font-bold appearance-none focus:outline-none focus:ring-0 peer"
                              />
                              <p className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 font-bold appearance-none focus:outline-none focus:ring-0 peer">
                                {commaShort(account?.regularMarketPrice)}
                              </p>
                            </div>
                          </div>
