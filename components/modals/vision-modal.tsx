                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-1">
                      ...
                      <p className="text-sm text-gray-600  my-4">
                        Here you can visualize your goals, both finincial and personal! Add text, stickets and media of how you see success for yourself in the future!
                      </p>
                    </div>
                  </div>
                </div>
