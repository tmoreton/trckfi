            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-1">
                      <p className="text-sm text-gray-600">
                        Here you can try out all Trckfi has to offer with fake credit cards and fake account data to test things out before you purchase over at Trckfi.com
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-pink-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-pink sm:ml-3 sm:w-auto"
