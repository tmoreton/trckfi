      ...
      <div className="w-full flex items-center mx-auto justify-center p-5">
        <div className="space-y-5">
          ...
          <Link href="/">
            <button
              type="button"
              className="rounded-full bg-white px-4 py-2.5 text-3xl font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 w-full my-3"
            >
              Button text
            </button>
          </Link>
