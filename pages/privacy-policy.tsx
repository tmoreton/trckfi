    ...
    <Layout>
      ...
      <Container>
        <div className="bg-white">
          <div className="mx-auto px-6 py-16 sm:py-16 lg:px-8">
            <div className="mx-auto">
              <h2 className="text-2xl font-bold leading-10 tracking-tight text-gray-900">Privacy Policy</h2>
              <div className="mt-6 text-base leading-7 text-gray-600">
                <p>TRCKFI, INC. PRIVACY POLICY</p>
                <br/>
                <p>Trckfi, Inc (the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service. </p>
                <br/>
                <p>
                For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at www.trckfi.com.
                “Service” refers to the Company’s services accessed via the Site, in which users can track and visualize their finances in one clean and easy to use dashboard. 
                The terms “we,” “us,” and “our” refer to the Company.
                “You” refers to you, as a user of our Site or our Service. 
                By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use (found here: www.trckfi.com/terms-of-use), and you consent to our collection, storage, use and disclosure of your Personal Information as described in this Privacy Policy.
                </p>
                <br/>
                <p>I. INFORMATION WE COLLECT</p>
                <br/>
                <p>We collect “Non-Personal Information” and “Personal Information.” Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit and preferences that are generated based on the data you submit and number of clicks. Personal Information includes your email and transaction information from bank statements and account balances, which you submit to us through the registration process at the Site.</p>
                <br/>
                <p>1.   Information collected via Technology</p>
                <br/>
                ...
                <br/>
                <p>2.   Information you provide us by registering for an account</p>
                <br/>
                ...
                <br/>
                <p>We implement security measures designed to protect your information from unauthorized access. Your account is protected by your email and we urge you to take steps to keep your personal information safe by not disclosing your email credentials and by logging out of your account after each use. We further protect your information from potential security breaches by implementing certain technological security measures including encryption, firewalls and secure socket layer technology. However, these measures do not guarantee that your information will not be accessed, disclosed, altered or destroyed by breach of such firewalls and secure server software. By using our Service, you acknowledge that you understand and agree to assume these risks.</p>
                <br/>
                ...
                <br/>
                <p>VI.           CHANGES TO OUR PRIVACY POLICY</p>
                <br/>
                ...
                <p>VII.         CONTACT US</p>
                <br/>
                <p>If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to support@trckfi.com.</p>
                <br/>
                <p>Last Updated: This Privacy Policy was last updated on 08-12-2023.</p>
              </div>
            </div>
          </div>
        </div>
