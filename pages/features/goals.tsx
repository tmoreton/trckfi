        ...
        <div className="py-16 sm:py-32">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="mx-auto text-center">
              <h4 className="text-base font-semibold leading-7 text-pink-600">Goals</h4>
              <h1 className="text-4xl font-bold text-gray-900 sm:text-6xl">
                Track your financial goals with Trckfi
              </h1>
              <p className="mt-6 text-md lg:text-xl lg:leading-8 text-gray-600">
                Unique money mindset—turn dreams into achievements. Set goals with images for visualization and motivation. Update details easily bank account, starting amount, timeframe. Stay motivated with Trckfi's financial goal-focused functionality
              </p>
              ...
              <div className="-m-2 rounded-xl lg:bg-gray-900/5 p-2 lg:ring-1 lg:ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                ...
                <div className="block lg:hidden relative mx-auto border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl mt-">
                  ...
                  <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white">
                    <img src="/assets/goals-mobile.png" className="rounded-lg" alt="Unlock the power of visualizing your money goalst" />
                  </div>
                </div>
              </div>
            </div>
