          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 sm:text-6xl">
                Your financial data in one place
              </h1>
              <p className="mt-6 text-md lg:text-xl lg:leading-8 text-gray-600">
                Gain financial clarity with our all-in-one money dashboard. Easily capture monthly snapshots of income, expenses, and savings. Effortlessly monitor account balances, net worth, and monthly spending by categories. 
                Simplify money management, keep your cash flow clear, and uncover easy opportunities to save with our money dashboard.
              </p>
