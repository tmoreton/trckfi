...
export default function ({ email, csrfToken }) {
  ...
  return loading ? <LoadingModal refreshing={loading} text='Creating your Account...'/> : <CheckEmail email={email} active={true} text="Success 🎉 Let's get ready to tackle our finances!"/>
}
