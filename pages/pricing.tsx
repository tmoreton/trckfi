      ...
      <Container>
        ...
        <div className="bg-white py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                  ...
                  <Link
                    ...
                    className={classNames(
                      ...
                      'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600'
                    )}
                  >
                    Buy plan
                  </Link>
            ...
            {/* lg+ */}
            <div className="isolate mt-20 hidden lg:block max-w-2xl mx-auto">
              <div className="relative -mx-8">
                {tiers.some((tier) => tier.mostPopular) ? (
                  <div className="absolute inset-x-4 inset-y-0 -z-10 flex">
                    <div
                      className="flex w-1/2 px-4"
                      aria-hidden="true"
                      style={{ marginLeft: `${(tiers.findIndex((tier) => tier.mostPopular) + 1) * 50}%` }}
                    >
                    ...
                    <tr>
                      ...
                      {tiers.map((tier) => (
                        <th key={tier.id} scope="col" className="px-6 pt-6 xl:px-8 xl:pt-8">
                          <div className="text-sm font-semibold leading-7 text-gray-900 text-center">{tier.name}</div>
                        </th>
                      ))}
                    </tr>
                  </thead>
                    ...
                    <tr>
                      ...
                      {tiers.map((tier) => (
                        <td key={tier.id} className="px-6 pt-2 xl:px-8">
                          <div className="flex justify-center gap-x-1 text-gray-900">
                            <span className="text-4xl font-bold">{tier.priceMonthly}</span>
                                ...
                                {typeof feature.tiers[tier.name] === 'string' ? (
                                  ...
                                  <>
                                    {feature.tiers[tier.name] === true ? (
                                      <CheckIcon className="mx-auto h-5 w-5 text-pink-600" aria-hidden="true" />
                                    ) : (
