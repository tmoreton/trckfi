        ...
        <Tailwind>
          <Body className="bg-white my-auto mx-auto font-sans">
            <Container className="mx-auto p-[20px] w-[465px]">
              ...
              <Text className="text-[#666666] text-[18px] my-4 leading-[24px] font-bold text-center inline-flex">
                <Emoji unified={transaction.unified} size={20}/><span className="ml-4">{transaction.name}</span>
              </Text>
