        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="my-[10px] mx-auto p-[20px] w-[650px]">
            ...
            <Section>
              ...
              <Text className="text-[18px]"><strong>Data Security:</strong> Your Privacy Matters. We never retain any personal information, login credentials or private transaction details. Trackfi uses a third party <Link href="https://plaid.com/en-eu/security/">plaid</Link> to securely encrypt and connect accounts to our platform.</Text>
            </Section>
            ...
            <Section> 
              <Text className="text-[18px] my-[5px]"><strong>Goals:</strong> Your financial planning hub! Start by setting your goals, specifying what you're saving for, your initial amount, your savings target, and the timeframe. Upload an image to keep your goal visual and manifest your financial dreams!</Text>
