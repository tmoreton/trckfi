    ...
    <Html>
      ...
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="p-[20px] w-[465px]">
            <Section>
              <Img
            ...
            <Heading className="text-black text-[48px] font-bold text-center p-0 my-[30px] mx-0">
            ...
            <Section className="text-center mt-[32px] mb-[32px]">
              <Button
                pX={20}
                pY={12}
                className="bg-pink-600 rounded text-white text-[24px] font-semibold no-underline text-center"
